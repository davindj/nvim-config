...
-- ALE Linter
noremap_silent("n", "<leader>ll", "<cmd>ALEFix<CR>")
noremap_silent("n", "<leader>ld", "<cmd>ALEDetail<CR>")
noremap_silent("n", "<leader>le", "<cmd>ALENext<CR>")
noremap_silent("n", "<leader>lE", "<cmd>ALEPrevious<CR>")
